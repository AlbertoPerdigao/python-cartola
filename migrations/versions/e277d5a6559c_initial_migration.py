...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['months_id'], ['months.id'], ),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=128), nullable=False),
    sa.Column('total_prize_percentage', sa.Numeric(precision=7, scale=2), nullable=False),
    sa.Column('first_place_percentage', sa.Numeric(precision=7, scale=2), nullable=False),
    sa.Column('second_place_percentage', sa.Numeric(precision=7, scale=2), nullable=False),
    sa.Column('tird_place_percentage', sa.Numeric(precision=7, scale=2), nullable=False),
    sa.Column('fourth_place_percentage', sa.Numeric(precision=7, scale=2), nullable=False),
    sa.Column('months_id', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['prizes_id'], ['prizes.id'], ),
    sa.ForeignKeyConstraint(['teams_id'], ['teams.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
